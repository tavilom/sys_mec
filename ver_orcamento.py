...
class VerOrcamento:
    def __init__(self):
        ...
        self.tree = ttk.Treeview(self.root, columns=("Item", "Placa do Carro", "Mão de Obra", "Valor Total"), show="headings")
    ...
    def carregar_orcamentos(self):
        ...
        for orcamento in orcamentos:
            self.tree.insert("", "end", values=(orcamento[1], orcamento[2], orcamento[3], orcamento[4]))
